...
import qualified Generic.Constants         as T2
import qualified Generic.OnChainHelpers    as OnChainHelpers (enumFromTo, getDatum_In_TxOut_And_Datum, getRedeemerForConsumeInput, getTxOutRefs_TxOuts_And_DatumTypes_From_TxOutRefs_TxOuts_By_CS, getTxOuts_And_DatumTypes_From_TxOuts_By_AC,
                                                              ...
                                                              isSignedByAny, isToken_Burning_With_CS_AndAmt, isToken_With_AC_InValue, isUnsafeEqDatums, isValidRange, isScriptAddress)
    ...
    where
        ...
        validateNonEmergencyRedeemers  =
            ...
            where
                ...
                --     ]
                !onChainHelpers_enumFromTo = OnChainHelpers.enumFromTo
                !onChainHelpers_getRedeemerForConsumeInput = OnChainHelpers.getRedeemerForConsumeInput
                -- !onChainHelpers_getTxOutRefs_TxOuts_And_DatumTypes_From_TxOutRefs_TxOuts_By_CS = OnChainHelpers.getTxOutRefs_TxOuts_And_DatumTypes_From_TxOutRefs_TxOuts_By_CS
                !onChainHelpers_getTxOuts_And_DatumTypes_From_TxOuts_By_AC_Campaign = OnChainHelpers.getTxOuts_And_DatumTypes_From_TxOuts_By_AC @T.ValidatorDatum @T.CampaignDatumType
                !onChainHelpers_getTxOuts_And_DatumTypes_From_TxOuts_By_AC_Protocol = OnChainHelpers.getTxOuts_And_DatumTypes_From_TxOuts_By_AC @ProtocolT.ValidatorDatum @ProtocolT.ProtocolDatumType
                -- !onChainHelpers_getTxOuts_And_DatumTypes_From_TxOuts_By_CS = OnChainHelpers.getTxOuts_And_DatumTypes_From_TxOuts_By_CS
                !onChainHelpers_getUnsafe_Own_Input_TxOut = OnChainHelpers.getUnsafe_Own_Input_TxOut
                !onChainHelpers_getDatum_In_TxOut_And_Datum = OnChainHelpers.getDatum_In_TxOut_And_Datum
                !onChainHelpers_getValue_In_TxOut_And_Datum = OnChainHelpers.getValue_In_TxOut_And_Datum
                !onChainHelpers_isDateInRange = OnChainHelpers.isDateInRange
                !onChainHelpers_isDateReached = OnChainHelpers.isDateReached
                !onChainHelpers_isEqValue = OnChainHelpers.isEqValue
                !onChainHelpers_isNFT_Burning_With_AC = OnChainHelpers.isNFT_Burning_With_AC
                !onChainHelpers_isNFT_Minting_With_CS = OnChainHelpers.isNFT_Minting_With_CS
                !onChainHelpers_isSignedByAny = OnChainHelpers.isSignedByAny
                !onChainHelpers_isToken_Burning_With_CS_AndAmt = OnChainHelpers.isToken_Burning_With_CS_AndAmt
                !onChainHelpers_isToken_With_AC_InValue = OnChainHelpers.isToken_With_AC_InValue
                !onChainHelpers_isUnsafeEqDatums = OnChainHelpers.isUnsafeEqDatums @T.CampaignDatumType
                !onChainHelpers_isValidRange = OnChainHelpers.isValidRange
                !onChainHelpers_isScriptAddress = OnChainHelpers.isScriptAddress
                ...
                inputsRef_TxOuts_ =
                    ...
                    in
                        filter ( onChainHelpers_isScriptAddress . LedgerApiV2.txOutAddress) list
                ------------------
                !inputs_TxOuts =
                    let
                ...
                !outputs_Own_txOuts =
                    let
                        ...
                        valid txOut = 
                            ...
                            in  onChainHelpers_isScriptAddress address && address == campaign_Validator_Address
                ...
                output_Own_TxOut_And_CampaignDatum_ =
                    fromMaybe
                        ...
                        ( case onChainHelpers_getTxOuts_And_DatumTypes_From_TxOuts_By_AC_Campaign 
                            ctx
                            outputs_Own_txOuts
                            campaignID_AC
                ...
                ------------------
                campaignDatum_Out_ = onChainHelpers_getDatum_In_TxOut_And_Datum output_Own_TxOut_And_CampaignDatum_
                valueOf_CampaignDatum_Out_ = onChainHelpers_getValue_In_TxOut_And_Datum output_Own_TxOut_And_CampaignDatum_
                --------------------------------------------------------------------------------
                ...
                inputRef_TxOut_And_ProtocolDatum'_ =
                    case onChainHelpers_getTxOuts_And_DatumTypes_From_TxOuts_By_AC_Protocol
                        ctx
                        inputsRef_TxOuts_
                        protocolID_AC_
                ...
                ------------------
                isCampaignOpen :: Bool
                isCampaignOpen = onChainHelpers_isDateReached (T.cdBeginAt campaignDatum_In) info && not (onChainHelpers_isDateReached (T.cdDeadline campaignDatum_In) info)
                 ------------------
                ...
                ------------------
                    case LedgerApiV2.txInfoOutputs info of
                        ...
                        (output:_) -> onChainHelpers_isToken_With_AC_InValue (LedgerApiV2.txOutValue output) tokenAdmin_AC
                        where
                ...
                ------------------
                    ...
                    ------------------
                    traceIfFalse "not isSignedByAny admins nor isAdminTokenPresent" (onChainHelpers_isSignedByAny admins info || isAdminTokenPresent)
                    where
                    ...
                    where
                        ...
                        !admins = case inputRef_TxOut_And_ProtocolDatum' of
                                Just x ->
                                    let
                                        ------------------
                                        !protocolDatum_In = onChainHelpers_getDatum_In_TxOut_And_Datum x
                                        ------------------
                ...
                isCorrect_Output_CampaignDatum_Value_NotChanged !valueOf_CampaignDatum_Out =
                    ...
                    in
                        valueOf_CampaignDatum_Out `onChainHelpers_isEqValue` valueFor_CampaignDatum_Out_Control
                --------------------------------------------------------------------------------
                ...
                validate_One_Input_One_Output_Redeemers !campaignDatum_Out !valueOf_CampaignDatum_Out = True
                    -- let
                    --     --------------------------
                ...
                validateRedeemerDelete !inputRef_TxOut_And_ProtocolDatum' = True
                    ------------------
                ...
                validateBasicUpdateRedeemers !inputRef_TxOut_And_ProtocolDatum' !campaignDatum_Out !valueOf_CampaignDatum_Out =
                    case redeemer of
                        (T.ValidatorRedeemerDatumUpdate _)  -> True
                            ---------------------
                            -- -- it runs alone
                            -- ---------------------
                        ...
                        ------------------
                        (T.ValidatorRedeemerUpdateMinADA _) -> True
                            -- ---------------------
                            -- -- it runs alone
                            -- ---------------------
                            -- -- Que sea Protocol or Campaign Admin
                ...
                validateRedeemerMilestoneManage !inputRef_TxOut_And_ProtocolDatum' !campaignDatum_Out !valueOf_CampaignDatum_Out =
                    case redeemer of
                        (T.ValidatorRedeemerMilestoneAprobe (T.ValidatorRedeemerMilestoneAprobeType rmaMilestoneIndex))   -> True
                            -- ---------------------
                            -- -- it runs alone
                            -- ---------------------
                            -- -- solo es posible actualizar admin y token admin
                            ...
                            --             campaignDatum_Out `OnChainHelpers.isUnsafeEqDatums` campaignDatum_Out_Control
                        ------------------
                        (T.ValidatorRedeemerMilestoneReprobe (T.ValidatorRedeemerMilestoneReprobeType rmrMilestoneIndex)) -> True
                            ---------------------
                            -- -- it runs alone
                            -- ---------------------
                            -- -- solo es posible actualizar admin y token admin
                ...
                validateFundsAddRedeemer !inputRef_TxOut_And_ProtocolDatum' !campaignDatum_Out !valueOf_CampaignDatum_Out = True
                    ------------------
                ...
                validateFundsManageRedeemers !inputRef_TxOut_And_ProtocolDatum' !campaignDatum_Out !valueOf_CampaignDatum_Out =
                    case redeemer of
                        (T.ValidatorRedeemerFundsMerge (T.ValidatorRedeemerFundsMergeType quantity))   -> True
                            ------------------
                        ...
                        ------------------
                        (T.ValidatorRedeemerFundsDelete (T.ValidatorRedeemerFundsDeleteType quantity)) -> True
                        --     ------------------
                ...
                validateFundsCollectRedeemers (T.ValidatorRedeemerFundsCollectType !date !amount_ADA) !campaignDatum_Out !valueOf_CampaignDatum_Out = True
                    --     ---------------------
                ...
                validateUpdateStatusCampaignRedeemers !inputsRef_TxOuts !inputRef_TxOut_And_ProtocolDatum' !campaignDatum_Out !valueOf_CampaignDatum_Out = True
                    -- case redeemer of
...
--                 ------------------
--                 !outputs_txOuts =
--                     [ txOut | txOut <- LedgerApiV2.txInfoOutputs info, onChainHelpers_isScriptAddress (LedgerApiV2.txOutAddress txOut)
--                     ]
...
--                         `OnChainHelpers.isUnsafeEqDatums` campaignDatum_Out_Control
...
--         ------------------
--         !inputsRef_TxOuts =
--             [ LedgerApiV2.txInInfoResolved txInfoInput | txInfoInput <- LedgerApiV2.txInfoReferenceInputs info, onChainHelpers_isScriptAddress (LedgerApiV2.txOutAddress $ LedgerApiV2.txInInfoResolved txInfoInput)
--             ]
--         ------------------
--         !campaignID_AC = LedgerValue.AssetClass (campaignPolicy_CS, T.campaignID_TN)
--         ------------------
