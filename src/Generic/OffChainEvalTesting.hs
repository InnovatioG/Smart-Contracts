...
-- import           PlutusTx                                        (UnsafeFromData (unsafeFromBuiltinData), applyCode, compile, getPlc, liftCode)
...
-- import qualified Protocol.Campaign.Types                             as CampaignT
...
-- import qualified Protocol.Campaign.Helpers                           as CampaignHelpers
-- import qualified Protocol.Campaign.Funds.Types                     as CampaignFundsT
...
--         !res = CampaignHelpers.calculateDepositCommissionsUsingMonths commissionPerYearInBPx1e3' deadline' date' deposit'
--     res
...
--         !res = CampaignHelpers.calculateWithdrawCommissionsUsingMonths commissionPerYearInBPx1e3' deadline' date' withdraw'
--     res
...
--     where
--     ------------------
--         !(userFT, commissionsFT, commissions_RatePerMonth_Numerator1e6) = CampaignHelpers.calculateDepositCommissionsUsingMonths commissionsTable_Numerator1e6 deadline date deposit
...
--     ------------------
--         -- !fundHoldingDatum_Control_With_Deposit = CampaignHelpers.mkUpdated_FundHoldingDatum_With_Deposit fundHoldingDatum_In deposit userFT commissionsFT commissions_RatePerMonth_Numerator1e6
--     ------------------
--         -- isMintingFT :: Bool
--         -- isMintingFT = CampaignHelpers.isToken_Minting_With_AC_AndAmt fundFT_AC deposit info

-- -- isCorrect_Output_FundHoldingDatum :: CampaignFundsT.FundHoldingDatumType -> Bool
-- -- isCorrect_Output_FundHoldingDatum fundHoldingDatum_Control =
-- --     let !fundHoldingDatum_Out = CampaignHelpers.getDatum_In_TxOut_And_Datum output_Own_TxOut_And_FundHoldingDatum
-- --     in  fundHoldingDatum_Out `CampaignHelpers.isUnsafeEqDatums` fundHoldingDatum_Control
-- ------------------
