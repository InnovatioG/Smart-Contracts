...
{-# INLINEABLE isToken_With_CS_And_Negative_Amt_InValue #-}
isToken_With_CS_And_Negative_Amt_InValue :: LedgerApiV2.Value -> LedgerApiV2.CurrencySymbol -> Bool
isToken_With_CS_And_Negative_Amt_InValue !value !cs = getAmtOfCurrencySymbol value cs < 0
...
{-# INLINEABLE isToken_Burning_With_CS #-}
isToken_Burning_With_CS :: LedgerApiV2.CurrencySymbol -> LedgerContextsV2.TxInfo -> Bool
isToken_Burning_With_CS !cs !info =
    let !mintingValue = LedgerApiV2.txInfoMint info
    in  isToken_With_CS_And_Negative_Amt_InValue mintingValue cs
